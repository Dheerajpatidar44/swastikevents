...
export default function Hero() {
  return (
    <section
      id="home"
      className="relative min-h-[70vh] flex items-center bg-[url('/herobg.webp')] bg-cover bg-bottom bg-no-repeat pt-32 pb-4 sm:pb-16 overflow-hidden"
    >
      {/* Background Overlay for better readability */}
      <div className="absolute inset-0 bg-charcoal/70 pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col justify-between relative h-full">
            ...
            <div className="relative">
              ...
              <svg className="absolute -top-12 left-[40%] w-32 h-32 text-white/5 animate-[spin_80s_linear_infinite] pointer-events-none" viewBox="0 0 100 100" fill="currentColor">
                <path d="M50 0 L53 35 L85 15 L62 42 L100 50 L62 58 L85 85 L53 65 L50 100 L47 65 L15 85 L38 58 L0 50 L38 42 L15 15 L47 35 Z" />
              </svg>

              {/* Gold Subheading Badge */}
              <span className="inline-block font-sans text-xs sm:text-sm font-bold tracking-[0.3em] text-gold-accent uppercase mb-4 text-left">
                Swastik Event & Decoration
              </span>

              {/* Main Premium Heading */}
              <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold text-white leading-[1.1] mb-6 text-left select-none drop-shadow-md">
                Crafting Grand <br />
                <span className="text-gold-accent">Celebrations</span>
              </h1>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-12 gap-6 items-end mt-4">
              {/* Left Bottom Image - landscape on mobile */}
              <div className="sm:col-span-5 relative aspect-[4/2.5] sm:aspect-[3.5/4] w-full overflow-hidden shadow-2xl bg-secondary lg:translate-y-16">
                <img
          ...
          <div className="lg:col-span-5 relative w-full flex flex-col items-center mt-10 lg:mt-0">
            <div className="flex flex-col items-center transform translate-y-2 lg:translate-x-16 lg:-translate-y-10 gap-6">
              {/* Large main right image - pushed further down on mobile */}
              <div className="w-full max-w-[280px] aspect-[3/4] overflow-hidden shadow-2xl bg-secondary mt-20 sm:mt-0">
                <img
